...
// La función substract hará lo mismo pero restando y la función father recibirá como parámetros a, b 
// y una función callback (sum o substract).
...
function father(a,b,operacion){
    numbersList.push(operacion(a,b));    
}
